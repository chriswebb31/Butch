...
public class GunCreator extends Gun {
    public GunCreator(String gunName) {
        ...
        try {
            ...
            switch(this.id) {
                case 10 :
                    this.gunWalking = new Animation<TextureRegion>(0.1f, ButchGame.assets.get(ButchGame.assets.revolverWalking, TextureAtlas.class).getRegions());
                    this.gunReloading = new Animation<TextureRegion>(0.1f, ButchGame.assets.get(ButchGame.assets.revolverReload, TextureAtlas.class).getRegions());
                    this.gunShooting = new Animation<TextureRegion>(0.1f, ButchGame.assets.get(ButchGame.assets.revolverFiring, TextureAtlas.class).getRegions());
                    this.spriteImg = new TextureRegion(ButchGame.assets.get(ButchGame.assets.coltSprite, Texture.class), 0, 0,27, 7);
