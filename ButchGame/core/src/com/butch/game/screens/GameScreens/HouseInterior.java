...
public class HouseInterior extends ModelGameScreen{
    public static TiledMap map = ButchGame.assets.get(ButchGame.assets.houseInterior);
    public HouseInterior(ButchGame game, FitViewport gameViewPort, TiledMap map, int spawnLocation) {
                ...
                if (endPoints.indexOf(endPointLoc) == 0) {
                    ...
                    Hud.stage.addAction(Actions.sequence(Actions.fadeOut(1), Actions.run(new Runnable() {
                        ...
                        public void run() {
                            ...
                            game.setScreen(new BigTown(game, gameViewPort, BigTown.map, 3));
                        }
                    })));
